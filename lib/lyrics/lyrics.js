...
function lyrics(song) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const singer = yield page.$('div[data-attrid="subtitle"]');
            ...
            if (songName || singer || songText) {
                const result = yield page.evaluate(() => {
                    ...
                    return ({
                        ...
                        singer: (_b = document === null || document === void 0 ? void 0 : document.querySelector('div[data-attrid="subtitle"]')) === null || _b === void 0 ? void 0 : _b.textContent,
                        lyric: (_c = document === null || document === void 0 ? void 0 : document.querySelector('div[data-lyricid]')) === null || _c === void 0 ? void 0 : _c.textContent
                    });
                });
                res.push(result);
            }
