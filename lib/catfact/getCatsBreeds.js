    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (wikitable) {
                ...
                const result = yield page.evaluate(() => [...document.querySelectorAll('.wikitable tbody tr')].map((el) => {
                    var _a, _b, _c, _d;
                    return ({
                        breed: (_a = el.querySelector('a')) === null || _a === void 0 ? void 0 : _a.innerHTML,
                        wiki: (_b = el.querySelector('a')) === null || _b === void 0 ? void 0 : _b.href,
                        origin: (_c = el
                            .querySelector('td')) === null || _c === void 0 ? void 0 : _c.innerText.replace(/[\W+|\d]/g, ' ').split(' ').filter((word) => word !== '').join(' '),
