        ...
        try {
            ...
            if (songName || singer || songText) {
                const result = yield page.evaluate(() => ({
                    ...
                    singer: (document === null || document === void 0 ? void 0 : document.querySelector('div[data-attrid="subtitle"]')).innerText,
                    lyric: (document === null || document === void 0 ? void 0 : document.querySelector('div[data-lyricid]')).innerText
                }));
                res.push(result);
            }
            if (res) {
